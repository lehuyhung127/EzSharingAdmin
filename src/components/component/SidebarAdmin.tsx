                                ...
                                <div className='nav-item dropdown'>
                                    ...
                                    <div className='dropdown-menu bg-transparent border-0'>
                                        <a href='' className='dropdown-item'>
                                            <i className='fa-regular fa-circle'></i> Admin Accounts
                                        </a>
                                        <a href='' className='dropdown-item'>
                                            <i className='fa-regular fa-circle'></i> Role
                                        </a>
                                        <a href='' className='dropdown-item'>
                                            <i className='fa-regular fa-circle'></i> Article Category
                                        </a>
                                        <a href='#' className='dropdown-item'>
                                            <i className='nav-icon fas fa-th'></i> Quiz Question Category
                                        </a>
                                        <a href='#' className='dropdown-item'>
                                            <i className='nav-icon fas fa-th'></i> Job Felix
                                        </a>
                                        <a href='#' className='dropdown-item'>
                                            <i className='nav-icon fas fa-th'></i> Jon Type
                                        </a>
                                    </div>
                                </div>
                            </Link>
